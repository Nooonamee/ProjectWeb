...
<% 
    ...
    ArrayList<sanPham> listSPdt1 = (ArrayList<sanPham>)request.getAttribute("listSPdt1");
    ArrayList<sanPham> listSPdt2 = (ArrayList<sanPham>)request.getAttribute("listSPdt2");
    int q = 0;
    if (listSP != null) {
        q = listSP.size();
    }
